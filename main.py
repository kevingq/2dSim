...
sim.setWorldSize([[-7.0, 7.0],[-3.0,2.0]])
sim.setInitialPosition(np.array([1.2,-0.2]))
sim.setInitialVelocity(np.array([2.0,0.0]))
sim.setInitialAcceleration(np.array([0.0,0.0]))
